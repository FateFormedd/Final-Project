...
def discussion():
    ...
    next_url = url_for('discussion', page=posts.next_num) \
        if posts.has_next else None
    prev_url = url_for('discussion', page=posts.prev_num) \
        if posts.has_prev else None
    return render_template('discussion.html', title='Home', form=form,
